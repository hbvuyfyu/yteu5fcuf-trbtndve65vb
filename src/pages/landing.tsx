      ...
      <section id="features" className="py-24 bg-slate-950/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Why Choose Cachvio?</h2>
      ...
      <footer className="py-12 bg-slate-950/50 border-t border-blue-900/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <CachvioLogo />
            <p className="text-slate-500 text-sm">© {new Date().getFullYear()} Cachvio. All rights reserved.</p>
