...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { label: "System Balance", value: `${stats?.totalBalanceInSystem ?? 0} USDT`, sub: "across all wallets", icon: Coins, color: "cyan", bgIcon: "bg-gradient-to-br from-cyan-500/20 to-teal-500/10", border: "border-cyan-500/15" },
    { label: "Total Withdrawn", value: `${stats?.totalWithdrawnAllTime ?? 0} USDT`, sub: "all time", icon: TrendingUp, color: "emerald", bgIcon: "bg-gradient-to-br from-emerald-500/20 to-green-500/10", border: "border-emerald-500/15" },
    { label: "Pending", value: stats?.pendingWithdrawals, sub: "awaiting review", icon: Clock, color: "red", bgIcon: "bg-gradient-to-br from-red-500/20 to-orange-500/10", border: "border-red-500/15" },
